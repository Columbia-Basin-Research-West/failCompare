...
```{r load}
data(rocky04)
taglife=rocky04$days   # vector of tag failure times
...
weib_mod=fail_fit(time=taglife,model="weibull")
weib_mod

vit13_mod=fail_fit(time=taglife,model="vitality.4p")
vit13_mod
...
fmods=fail_fit(taglife,c("weibull","gompertz","gamma","lognormal"))
fmods
par(mfrow=c(1,1))
plot(fmods)
fail_rank(fmods)
...
fmods_all=fail_fit(taglife,"all")
fmods_all
fmods_all_ranked=fail_rank(fmods_all)
par(mfrow=c(1,1))
